...
public:
	...
	Gtk::Button b_delay_, b_distorsion_, b_normalisation_, b_inverse_, b_volume_, b_chuchotement_, b_vinyl_, b_bassboost_, b_lowpass_, b_highpass_, b_partition_, b_accompagnement_;
};
